	...
	'columns'=>array(
		...
		array(
				...
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>'
					...
					"项目统计：" . $data->Content_Store->Store_Items_Count
				'),
		),
		array(
				'class'=>'DataColumn',
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:65px;'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'				
						$data->getAttributeLabel("Content_Store.login_ip").":".$data->Content_Store->login_ip						
				'),
		),
		array(
				'class'=>'DataColumn',
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:65px;'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'
						$data->getAttributeLabel("Content_Store.last_ip").":".$data->Content_Store->last_ip				
				'),
		),
		array(
				'filter'=>$this->widget('zii.widgets.jui.CJuiDatePicker',array(
		...
		array(
			...
			'buttons'=>array(
					...
					'items'=>array(
						'label'=>'查看项目',
						'visible'=>'$data->Content_Store->Store_Items_Count > 0',
						'url'=>'Yii::app()->createUrl("/operator/items/admin", array("store_id"=>$data->id))',
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
			),
