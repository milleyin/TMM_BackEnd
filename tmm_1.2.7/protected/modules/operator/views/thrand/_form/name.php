									...
									foreach ($items->Pro_Items->Items_ItemsImg as $img)
									{
										if ($this->file_exists_uploads($img->img))
										{
											echo Yii::app()->controller->show_img($img->img, '', '', array(
													'title'=>Yii::app()->controller->setHideKey($items->Pro_Items->Items_StoreContent->Content_Store->phone) . ' [' .
...
<div class="selecting">
	<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/operator/box.png">
</div>
<div id="list_dot" >
	<div id="dot_top">
	<?php 
