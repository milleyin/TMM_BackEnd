...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model->Store_Content,'lx_identity_code',array('size'=>15,'maxlength'=>15)); ?>
	...
	<div class="row">
        ...
        <?php 
			if($this->file_exists_uploads($model->Store_Content->identity_before)){
				echo '<div class="row"><label>显示图片</label>';
				echo CHtml::image($model->Store_Content->identity_before,'',array('style'=>'width:300px;'));
				echo '</div>';
			}
	?>
	<div class="row">
		...
		<?php echo $form->error($model->Store_Content,'identity_after'); ?>
         ...
         <?php 
			if($this->file_exists_uploads($model->Store_Content->identity_after)){
				echo '<div class="row"><label>显示图片</label>';
				echo CHtml::image($model->Store_Content->identity_after,'',array('style'=>'width:300px;'));
				echo '</div>';
			}
	?>
	<div class="row">
		...
		<?php echo $form->error($model->Store_Content,'identity_hand'); ?>
         ...
         <?php 
			if($this->file_exists_uploads($model->Store_Content->identity_hand)){
				echo '<div class="row"><label>显示图片</label>';
				echo CHtml::image($model->Store_Content->identity_hand,'',array('style'=>'width:300px;'));
				echo '</div>';
			}
	?>
	<div class="row">
	...
	<div class="row">
		...
		<?php echo $form->textField($model->Store_Content,'com_identity',array('size'=>15,'maxlength'=>15)); ?>
		<?php echo $form->error($model->Store_Content,'com_identity'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model->Store_Content,'bl_code'); ?>
		<?php echo $form->textField($model->Store_Content,'bl_code',array('size'=>60,'maxlength'=>100)); ?>
		...
		<?php echo $form->error($model->Store_Content,'bl_img'); ?>
         ...
         <?php 
			if($this->file_exists_uploads($model->Store_Content->bl_img)){
				echo '<div class="row"><label>显示图片</label>';
				echo CHtml::image($model->Store_Content->bl_img,'',array('style'=>'width:300px;'));
				echo '</div>';
			}
	?>
        <div class="row">
		<?php echo $form->labelEx($model,'agent_id'); ?>
		<?php echo $form->dropDownList($model,'agent_id',Agent::data()); ?>
