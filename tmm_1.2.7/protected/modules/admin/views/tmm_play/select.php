...
$this->breadcrumbs=array(
	...
	$select->Play_Items->name=>array('view','id'=>$select->id),
	'选择标签页'
);
...
");
?>
<h1>选择标签 <font color='#eb6100'><?php echo CHtml::encode($select->Play_Items->name); ?></font></h1>
<div>
	<span>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		//		'value'=>'$data->id',
				'id'=>'tags',
				'checked'=>'TagsElement::checked_element($data->id,'.$select->id.','.TagsElement::tags_items_play.')',
...
$url=Yii::app()->createUrl('/admin/tmm_play/Tags',array('id'=>$select->id));
