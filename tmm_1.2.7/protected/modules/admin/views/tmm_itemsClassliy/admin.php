...
$('.search-form form').submit(function(){
	$('#items-classliy-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div>
	 ...
	 <span>
	 	<?php echo CHtml::link('创建项目分类',array('create')); ?>	</span>
</div>
...
function(){ 
	...
	$.fn.yiiGridView.update('items-classliy-grid',{  
	type:'POST',
...
function() {  
	...
	jQuery('#items-classliy-grid').yiiGridView('update', {
		type: 'POST',
...
// 						'url'=>'Yii::app()->createUrl("/admin/tmm_itemsClassliy/disable",array("id"=>$data->id))',
// 						'click'=>$click,
// 						'options'=>array('style'=>'padding:0 8px 0 0;'),
// 					),
// 					'start'=>array(
...
// 						'url'=>'Yii::app()->createUrl("/admin/tmm_itemsClassliy/start",array("id"=>$data->id))',
// 						'click'=>$click,
// 						'options'=>array('style'=>'padding:0 8px 0 0;'),
// 					),
			),
