...
<div class="group_container">
    ...
    $info_array = array();
    $data_array = array();
    foreach ($model->OrderActives_OrderItems as $value)
    {
                            ...
                            <div class="item">
                                ...
                                <div class="item_content">
                                    <h3>
                                        ...
                                        &nbsp;&nbsp;消费码：
                                        <span style="width: 60px;" title="<?php echo $items->employ_time==0?'':date('Y-m-d H:i:s');?>">
                                            <?php
                                            echo CHtml::encode(OrderItems::$_is_barcode[$items->is_barcode]); ?>
                                        </span>
