...
$model->criteria_search = $dataProvider->getCriteria();

$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'account-log-grid',
	'dataProvider'=>$dataProvider,
	'enableHistory'=>true,
	'summaryText'=>'<div style="text-align:left;line-height:22px;font-size:16px;letter-spacing:1px;">'.
		implode('<br>', array(
			'<strong>统计：</strong>&yen; <strong>'.$model->getRmbCount().' </strong>元',
			'<strong>收入：</strong>&yen; <strong>'.$model->getEntryRmbCount().' </strong>元',
			'<strong>支出：</strong>&yen; <strong>'.$model->getDeductRmbCount().' </strong>元',
			'<strong>冻结：</strong>&yen; <strong>'.$model->getPendingRmbCount().' </strong>元',			
			'<strong>记录：</strong>&yen; <strong>'.$model->getRecordRmbCount().' </strong>元',
	...
	'columns'=>array(
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:120px;','title'=>'to/from 接受或来自资金的角色类型'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:120px;','title'=>'to/from 接受或来自资金的账号'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'
		...
		array(
				...
				//'filter'=>,
				'name'=>'money',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:120px;','title'=>'当前资金前的账号原可用余额'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'
...
// 		),
		array(
				...
				//'filter'=>,
				'name'=>'after_money',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:120px;','title'=>'after 当前资金后的账号可用余额'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'
