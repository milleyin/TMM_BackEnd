...
<div>
	 ...
	 <span>
	 	<?php echo CHtml::link('创建Refund',array('create')); ?>	</span>
</div>
...
function() {  
	...
	jQuery('#refund-grid').yiiGridView('update', {
		type: 'POST',
		...
		array(
			...
			'buttons'=>array(
					...
					'disable'=>array(
						...
						'url'=>'Yii::app()->createUrl("/admin/tmm_refund/disable",array("id"=>$data->id))',
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
					'start'=>array(
						'label'=>'激活',
						'visible'=>'$data->status==0',
						'url'=>'Yii::app()->createUrl("/admin/tmm_refund/start",array("id"=>$data->id))',
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
			),
