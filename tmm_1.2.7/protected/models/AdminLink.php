...
/**
 * This is the model class for table "{{admin_link}}".
 *
 * The followings are the available columns in table '{{admin_link}}':
 * @property string $id
 ...
 */
class AdminLink extends CActiveRecord
{
	/**
	 * 导航
	 * @var unknown
	...
	*/
	...
	public function rules()
	{
		...
		return array(
			...
			array('name,title,info,sort', 'safe', 'on'=>'group'),
			array('p_id,url,params,target,up_time,add_time,show,status', 'unsafe', 'on'=>'group'),
			
			array('nav', 'numerical', 'integerOnly'=>true,'on'=>'mgroup'),
			array('nav', 'required','on'=>'mgroup'),
			array('nav,name,title,info,sort','safe', 'on'=>'mgroup'),
			array('p_id,url,params,target,up_time,add_time,show,status', 'unsafe', 'on'=>'mgroup'),
				
			array('nav,group', 'numerical', 'integerOnly'=>true,'on'=>'mmenu'),
			array('nav,group','required','on'=>'mmenu'),
	...
	public function relations()
	{
		...
		return array(
				'Link_Link'=>array(self::HAS_MANY,'AdminLink','p_id'),
				'Link_Link_Link'=>array(self::HAS_MANY,'AdminLink','p_id'),
		);
	}
...
// 		$navbar[]=array(
// 				'label'=>'退出系统('.Yii::app()->admin->name.')',
// 				'url'=>array('/admin/tmm_login/out'),
// 				'linkOptions'=>array(
// 						'title'=>Yii::app()->admin->username,
// 						'target'=>'_parent'
// 				)
// 		);
		return $navbar;
