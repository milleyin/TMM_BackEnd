	   	...
	   	?>
				<div class="dot_info">
					<div class="dot_content">
						...
						<span><?php echo CHtml::link($info_array['dot_data'][$dot_name]->name, array('/admin/tmm_dot/view', 'id'=>$info_array['dot_data'][$dot_name]->id)); ?></span>
					</div>
					<div class="item_list">
					<?php 
					...
					?>
						...
						<div class="list_title">
							...
							<?php 		
								echo CHtml::link($items->Pro_Items->name, array('/admin/tmm_' . $items->Pro_Items->Items_ItemsClassliy->admin . '/view', 'id'=>$items->Pro_Items->id));
					 	...
					 	<div class="list_store">
							...
							<span title="运营商账号"> | 
								<?php echo CHtml::encode($items->Pro_Items->Items_agent->phone); ?>
							</span>
							<label class="name">
								供应商：
							</label>
