...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'push_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'push_element'); ?>
			<?php echo $form->dropDownList($model,'push_element',array(''=>'--请选择--')+$model::$_push_element); ?>
		</div>
