<div class="group_container">
    <div class="group_header">
        ...
        <?php
        if(isset($model->Group_Pro[0]->Pro_Group_Thrand))
            echo CHtml::link($model->Group_Pro[0]->Pro_Group_Thrand->Thrand_Shops->name.' [ID:'.$model->Group_Pro[0]->Pro_Group_Thrand->id.']',array('/admin/tmm_'.$model->Group_ShopsClassliy->admin.'/view','id'=>$model->Group_Pro[0]->Pro_Group_Thrand->id));
        ?>
    </div>
    <?php
    ...
    foreach ($data_array as $key=>$data_dot_sort)
    {
        ...
        <div class="group_wrap">
                                ...
                                <div class="item_content">
                                    <h3>
                                        ...
                                        <span
                                            ...
                                            <?php echo CHtml::encode($items->Pro_Items->Items_ItemsClassliy->name); ?></span>
                                    </h3>
                                    ...
                                    <div class="address">
                                        <label >地址：</label>
                                <span><?php echo
                                    CHtml::encode($items->Pro_Items->Items_area_id_p_Area_id->name,
            ...
            <div class="warp_right">
                <h4>日程亮点：</h4>
                <?php echo $form->hiddenField($info_array[$key]['data'],"[$key]id");?>
                <?php echo $form->textArea($info_array[$key]['data'],"[$key]info");?>
                <?php echo $form->error($info_array[$key]['data'],"[$key]info");?>
            </div>
            <div class="clearfix"></div>
        </div>
        <?php
