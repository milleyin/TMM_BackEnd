            ...
            <div class="row-fluid line_all">
                ...
                <?php
                    foreach ($data_dot_sort as $data_dot)
                    {
                        ...
                        {
                ?>
                        <div class="spot_name"><?php echo CHtml::link(CHtml::encode($info_array['dot_data'][$dot_id]->name),array('/agent/agent_dot/view','id'=>$dot_id)); ?></div>
                        <?php
            ...
            <div class="content">
                ...
                <?php 
                	if(isset($info_array[$key]))
                		echo CHtml::encode($info_array[$key]['info']);
                	else 
