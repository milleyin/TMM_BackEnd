...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'login_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>
	...
	<div class="row">
		...
		<div class="row">
			<?php echo $form->label($model,'login_source'); ?>
			<?php echo $form->dropDownList($model,'login_source',array(''=>'--请选择--')+$model::$_login_source);?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'login_type'); ?>
			<?php echo $form->dropDownList($model,'login_type',array(''=>'--请选择--')+$model::$_login_type);?>
		</div>
