...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
				...
				//'filter'=>,
				'name'=>'actives_id',
				'value'=>'$data->OrderActives_Actives->Actives_Shops->name',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'$data->OrderActives_Actives->id'),
		),
		array(
				//'class'=>'DataColumn',
				//'evaluateHtmlOptions'=>true,
				//'filter'=>,
				'filter'=>CHtml::activeDropDownList($model, 'actives_type',array(''=>'')+OrderActives::$_actives_type, array('id'=>false)),
				'name'=>'actives_type',
		...
		array(
				//'class'=>'DataColumn',
				//'evaluateHtmlOptions'=>true,
				'filter'=>CHtml::activeDropDownList($model, 'status',array(''=>'')+OrderActives::$_status, array('id'=>false)),
				'name'=>'status',
...
// 					'refund'=>array(
// 						'label'=>'申请退款',
// 						'visible'=>'$data->status==1 && OrderItems::Apply_actives($data->id)',
// 						'click'=>$click,
// 						'url'=>'Yii::app()->createUrl("/admin/tmm_orderActives/refund",array("id"=>$data->id))',
// 						'options'=>array('style'=>'padding:0 8px 0 0;'),
// 					),
			),
