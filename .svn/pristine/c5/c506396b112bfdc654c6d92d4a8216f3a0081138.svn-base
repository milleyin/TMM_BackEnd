<div class="content_box" id="page_project_create">
	...
	echo $this->breadcrumbs(array(
		...
		'项目创建',
		$model->Play_Items->Items_Store_Manager->phone,
	));
	?>
	<!--.title-->
		...
		<div class="content_two">
			...
			<div class="row-fluid project_type_row-fluid">
				...
				<select name="c_id" class="project_type" onchange="self.location.href=options[selectedIndex].value" >
					...
					foreach ($ItemsClassliys as $ItemsClassliy){
						?>
						<option <?php echo $model->Play_Items->c_id==$ItemsClassliy->id?'selected="selected"':'';?> title="<?php echo CHtml::encode($ItemsClassliy->info);?>" value="<?php echo Yii::app()->createUrl('/agent/agent_'.$ItemsClassliy->admin.'/create',array('id'=>$model->Play_Items->Items_Store_Manager->id));?>">
			...
			<div class="row-fluid do_time">
				...
				<div class="col-start">
					...
					?><?php echo $form->error($model->Play_Items,'start_work'); ?></div>
				<div class="division">
				</div>
				<div class="col-stop">
					<?php
					...
					?><?php echo $form->error($model->Play_Items,'end_work'); ?></div>
			</div>
