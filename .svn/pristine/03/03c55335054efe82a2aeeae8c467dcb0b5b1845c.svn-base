...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
	  ...
	  <div class="row">
			...
			<?php echo $form->textField($model->Store_Content,'name',array('size'=>60,'maxlength'=>128)); ?>
		</div>
                <div class="row">
			<?php echo $form->label($model->Store_Content,'address'); ?>
			<?php echo $form->textField($model->Store_Content,'address',array('size'=>60,'maxlength'=>100)); ?>
		</div>
		<div class="row">
			<?php echo $form->label($model,'p_id'); ?>
			<?php echo $form->textField($model,'p_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>
	    ...
	    <div class="row">
			<?php echo $form->label($model->Store_Content,'bank_id'); ?>
			<?php echo $form->dropDownList($model->Store_Content,'bank_id',Bank::data_name()); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model->Store_Content,'bank_name'); ?>
			<?php echo $form->textField($model->Store_Content,'bank_name',array('size'=>11,'maxlength'=>11)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model->Store_Content,'bank_branch'); ?>
			<?php echo $form->textField($model->Store_Content,'bank_branch',array('size'=>60,'maxlength'=>100)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model->Store_Content,'bank_code'); ?>
			<?php echo $form->textField($model->Store_Content,'bank_code',array('size'=>50,'maxlength'=>50)); ?>
		</div>
		...
		<div class="row">
			<?php echo $form->label($model,'login_token'); ?>
			<?php echo $form->textField($model,'login_token',array('size'=>60,'maxlength'=>128)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'login_mac'); ?>
			<?php echo $form->textField($model,'login_mac',array('size'=>60,'maxlength'=>128)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'last_mac'); ?>
			<?php echo $form->textField($model,'last_mac',array('size'=>60,'maxlength'=>128)); ?>
		</div>
	...
	<div class="row">
			...
			?>	
				...
				<div class="row">
			<?php echo $form->label($model,'last_address'); ?>
			<?php echo $form->textField($model,'last_address',array('size'=>60,'maxlength'=>100)); ?>
		</div>
