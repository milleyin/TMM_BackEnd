...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			<?php echo $form->label($model,'day_sort'); ?>
			<?php echo $form->textField($model,'day_sort'); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'half_sort'); ?>
		...
		<div class="row">
			<?php echo $form->label($model,'dot_id'); ?>
			<?php echo $form->textField($model,'dot_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'thrand_id'); ?>
			<?php echo $form->textField($model,'thrand_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>
