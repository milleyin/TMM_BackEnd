...
$this->breadcrumbs=array(
	'线路管理页'=>array('/admin/tmm_actives/admin'),
	'线路(活动)管理页'=>array('admin'),
	$select->Actives_Shops->name=>array('view','id'=>$select->id),
	'选择标签页'
);
...
");
?>
<h1>选择标签 <font color='#eb6100'><?php echo CHtml::encode($select->Actives_Shops->name); ?></font></h1>
<div>
<span>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		//		'value'=>'$data->id',
				'id'=>'tags',
				'checked'=>'TagsElement::checked_element($data->id,'.$select->id.','.TagsElement::tags_shops_actives.')',
...
$url=Yii::app()->createUrl('/admin/tmm_actives/Tags',array('id'=>$select->id));
