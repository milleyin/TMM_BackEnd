...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php $model->timeSearchInput($model, 'exchange_time');?>
    </div>
 
    <div class="row">
        <?php echo $form->label($model,'exchange_status'); ?>
        <?php echo $form->dropDownList($model, 'exchange_status', array(''=>'--请选择--')+$model::$_exchange_status); ?>
    </div>
    
    <div class="row">
        <?php echo $form->label($model,'print_status'); ?>
        <?php echo $form->dropDownList($model, 'print_status', array(''=>'--请选择--')+$model::$_print_status); ?>
    </div>
