...
<div>
	...
	<span>
		<?php echo CHtml::link('创建User', array('create')); ?>	
	</span>
</div>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('openid') . '：' . $data->openid;
					}
				),
		),
		array(
			...
			'buttons'=>array(
					...
					'disable'=>array(
						...
						'url'=>function ($data, $row) {
							...
							//return Yii::app()->createUrl('/admin/user/disable', array('id'=>$data->id));
						},
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
					'start'=>array(
						...
						'url'=>function ($data, $row) {
							...
							//return Yii::app()->createUrl('/admin/user/start', array('id'=>$data->id));
						},
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
					'restore'=>array(
						...
						'url'=>function ($data, $row) {
							...
							//return Yii::app()->createUrl('/admin/user/restore', array('id'=>$data->id));
						},
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
