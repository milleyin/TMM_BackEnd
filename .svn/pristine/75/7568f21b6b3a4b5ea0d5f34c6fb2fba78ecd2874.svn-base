...
class Menu extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('p_id, manager_id', 'length', 'max'=>20),
            array('name, title', 'length', 'max'=>64),
            array('info, route', 'length', 'max'=>128),
            array('up_time, add_time', 'length', 'max'=>10),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, type, p_id, manager_id, name, title, info, route, sort, up_time, add_time, status', 'safe', 'on'=>'search'),
        );
    }
