 ...
 *
 */
class Agent_adminLinkController extends AgentController
{
    ...
    {
        $this->addJs(Yii::app()->baseUrl.'/css/agent/ext/checktree/jquery-1.3.2.js');
        $this->addJs(Yii::app()->baseUrl.'/css/agent/ext/checktree/jquery.checktree.js');
        $this->addCss(Yii::app()->baseUrl.'/css/agent/ext/checktree/checktree.css');
        $this->addCss(Yii::app()->baseUrl.'/css/agent/ext/tree.css');
    ...
    public function actionGroup($id){
        ...
        if(isset($_POST['AgentLink']))
        {
            ...
            $model->p_id=$id;
            if($model->save() && $this->log('创建系统分组',ManageLog::agent,ManageLog::create))
                $this->back();
        }
    ...
    public function actionUpgroup($id){
        ...
        {
            $model->attributes=$_POST['AgentLink'];
            if($model->save() && $this->log('修改系统分组',ManageLog::agent,ManageLog::update))
                $this->back();
        }
        $this->render('group',array(
            'model'=>$model,'group'=>$group,
    ...
    public function actionMovegroup($id){
        ...
        if(isset($_POST['AgentLink']))
        {
            ...
            if($model->save() && $this->log('移动系统分组',ManageLog::agent,ManageLog::update))
                $this->back();
        }
    ...
    public function actionMenu($id){
        ...
        if(isset($_POST['AgentLink']))
        {
            $model->attributes=$_POST['AgentLink'];
            $model->p_id=$id;
            if($model->save() && $this->log('创建系统链接',ManageLog::agent,ManageLog::create))
                $this->back();
        }
    ...
    public function actionUpaction($id){
        ...
        {
            $model->attributes=$_POST['AgentLink'];
            if($model->save() && $this->log('修改系统链接',ManageLog::agent,ManageLog::update))
                $this->back();
        }
        $this->render('menu',array(
            'model'=>$model,'menu'=>$menu,
    ...
    public function actionMoveaction($id){
        ...
        if(isset($_POST['AgentLink']))
        {
            ...
            if($model->save() && $this->log('移动系统链接',ManageLog::agent,ManageLog::update))
                $this->back();
        }
    ...
    public function actionUpdate($id)
    {
        ...
        {
            $model->attributes=$_POST['AgentLink'];
            if($model->save() && $this->log('更新系统导航',ManageLog::agent,ManageLog::update))
                $this->back();
        }
    ...
    public function actionCreate()
    {
        ...
        {
            $model->attributes=$_POST['AgentLink'];
            if($model->save() && $this->log('创建系统导航',ManageLog::agent,ManageLog::create))
                $this->back();
        }
    ...
    public function actionSort(){
        ...
        if(isset($return))
            $this->log('修改导航排序',ManageLog::agent,ManageLog::update);
        $this->back();
    }
    ...
    public function actionDelete($id)
    {
        if($this->loadModel($id)->updateByPk($id,array('status'=>-1)))
            $this->log('删除导航/分组/链接',ManageLog::agent,ManageLog::delete);
    ...
    public function actionHide($id){
        ...
        if($model)
            $this->log('隐藏导航',ManageLog::agent,ManageLog::update);
        $this->back();
    }
    ...
    public function actionShow($id){
        ...
        if($model)
            $this->log('显示导航',ManageLog::agent,ManageLog::update);
        $this->back();
    }
    ...
    public function actionDisable($id){
        ...
        if($model)
            $this->log('禁用导航/分组/链接',ManageLog::agent,ManageLog::update);
        $this->back();
    }
    ...
    public function actionStart($id){
        ...
        if($model)
            $this->log('激活导航/分组/链接',ManageLog::agent,ManageLog::update);
        $this->back();
    }
}
