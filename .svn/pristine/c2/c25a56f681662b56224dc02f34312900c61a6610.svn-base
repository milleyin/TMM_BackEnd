...
/**
 * This is the model class for table "{{shops_info}}".
 *
 * The followings are the available columns in table '{{shops_info}}':
 * @property integer $shops_id
 * @property string $info
 */
class ShopsInfo extends CActiveRecord
{
	/**
	 * 搜索的时间类型
	 * @var array
	...
	public function rules()
	{
		...
		return array(
			...
			array('search_time_type,search_start_time,search_end_time,shops_id, info', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'ShopsInfo_Actives'=>array(self::HAS_ONE,'Actives',array('id'=>'shops_id')),
		);
	}
	 ...
	 * @return ShopsInfo the static model class
	 */
