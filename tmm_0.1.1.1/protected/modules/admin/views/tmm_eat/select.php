...
$this->breadcrumbs=array(
	...
	$select->Eat_Items->name=>array('view','id'=>$select->id),
	'选择标签页'
);
...
");
?>
<h1>选择标签 <font color='#eb6100'><?php echo CHtml::encode($select->Eat_Items->name); ?></font></h1>
<div>
	<span>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		//		'value'=>'$data->id',
				'id'=>'tags',
				'checked'=>'TagsElement::checked_element($data->id,'.$select->id.','.TagsElement::tags_items_eat.')',
...
$url=Yii::app()->createUrl('/admin/tmm_eat/Tags',array('id'=>$select->id));
