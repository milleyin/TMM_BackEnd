...
class Pro extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('sort, day_sort, half_sort, audit, status', 'numerical', 'integerOnly'=>true),
			...
			array('search_time_type,search_start_time,search_end_time,id, shops_id, agent_id, store_id, shops_c_id, c_id, thrand_id, info, add_time, up_time, audit, status', 'safe', 'on'=>'search,create_actives,update_actives'),
