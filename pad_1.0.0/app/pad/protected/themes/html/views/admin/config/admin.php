...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
		        'class'=>'DataColumn',
		        'evaluateHtmlOptions'=>true,
		        'filter'=>CHtml::activeTextField($model->Config_Upload, 'path', array('id'=>false)),
		        'name'=>'Config_Upload.path',
		        'type'=>'raw',
		        'value'=>function ($data, $row) {
		            return CHtml::image($data->Config_Upload->getUrlPath(), CHtml::encode($data->Config_Upload->info), array('title'=>$data->Config_Upload->info,'style'=>'width:80px;height:60px;'));
		        },
		        'headerHtmlOptions'=>array('style'=>'text-align:center;width:100px;'),
		        'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
    		            return $data->getAttributeLabel('Config_Upload.info') . '：' . $data->Config_Upload->info;
    		        },
		        ),
		),
		array(
