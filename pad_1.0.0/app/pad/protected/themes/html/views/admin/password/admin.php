...
<div>
	...
	<span>
		<?php echo CHtml::link('创建Password', array('create')); ?>	
	</span>
</div>
...
function reinstallDatePicker(id, data) {
	jQuery('#use_time_date').datepicker(jQuery.extend({showMonthAfterYear:false},jQuery.datepicker.regional['zh-CN'],{'maxDate':'new date()','dateFormat':'yy-mm-dd','showOn':'focus','showOtherMonths':true,'selectOtherMonths':true,'changeMonth':true,'changeYear':true,'showButtonPanel':true}));
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('password') . '：' . $data->password;
					}
				),
		),
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('salt') . '：' . $data->salt;
					}
				),
		),
		/*
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('pass_count') . '：' . $data->pass_count;
					}
				),
		),
		array(
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('use_error') . '：' . $data->use_error;
					}
				),
		),
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('use_ip') . '：' . $data->use_ip;
					}
				),
		),
		array(
				...
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('use_time') . '：' . Yii::app()->format->FormatDate($data->use_time);
					},
				),
		),
		array(
		...
		array(
				...
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
						return $data->getAttributeLabel('up_count') . '：' . $data->up_count;
					}
				),
		),
		array(
			...
			'buttons'=>array(
					...
					'disable'=>array(
						...
						'url'=>function ($data, $row) {
							...
							//return Yii::app()->createUrl('/admin/password/disable', array('id'=>$data->id));
						},
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
					'start'=>array(
						...
						'url'=>function ($data, $row) {
							...
							//return Yii::app()->createUrl('/admin/password/start', array('id'=>$data->id));
						},
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
					'restore'=>array(
						...
						'url'=>function ($data, $row) {
							...
							//return Yii::app()->createUrl('/admin/password/restore', array('id'=>$data->id));
						},
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					),
