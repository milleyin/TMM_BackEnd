...
class Prize extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('odds, count', 'required', 'on'=>'thanks'),
            array('odds, count', 'safe', 'on'=>'thanks'),
            array('id, store_id, pad_id, config_id, manager_id, name, info, url, number, receive_type, position, up_time, add_time, status', 'unsafe', 'on'=>'thanks'),
