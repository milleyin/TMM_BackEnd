...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?php echo $form->errorSummary(array($model, $model->Store_Password)); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model->Store_Password, '_pwd'); ?>
        <?php echo $form->passwordField($model->Store_Password,'_pwd',array('size'=>25,'maxlength'=>25)); ?>
        <?php echo $form->error($model->Store_Password, '_pwd'); ?>
    </div>
    
    <div class="row">
        <?php echo $form->labelEx($model->Store_Password, '_confirm_pwd'); ?>
        <?php echo $form->passwordField($model->Store_Password, '_confirm_pwd',array('size'=>25,'maxlength'=>25)); ?>
        <?php echo $form->error($model->Store_Password, '_confirm_pwd'); ?>
    </div>
