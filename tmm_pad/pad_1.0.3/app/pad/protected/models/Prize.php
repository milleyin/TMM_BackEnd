...
class Prize extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('odds', 'match', 'pattern'=>'/^(\d{1,2}(\.\d{1,2})?|100|-1)$/', 'on'=>'update, update_yz'),
            ...
            array('odds', 'match', 'pattern'=>'/^(\d{1,2}(\.\d{1,2})?|100|-1)$/', 'on'=>'thanks'),
    ...
    public function search()
    {
        ...
        if ($this->odds == -1)
            $criteria->compare('t.odds', $this->odds);
        else
            $criteria->compare('t.odds/100', $this->odds);
    ...
    public function getOddsPercent()
    {
        return $this->odds != -1 ? $this->odds / 100 : $this->odds;
    }
    
    public function setOddsInteger()
    {
        return $this->odds != -1 ? $this->odds * 100 : $this->odds;
    }
