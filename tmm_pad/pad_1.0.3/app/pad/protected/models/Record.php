...
class Record extends ActiveRecord
{
    ...
    public static $_exchange_status = array(
        self::RECORD_EXCHANGE_STATUS_QUIT => '已放弃',
        self::RECORD_EXCHANGE_STATUS_SELECT => '待选择',
     ...
     * @var integer
     */
    const RECORD_PRINT_STATUS_NONE = -1;
    /**
     * 未打印
     * @var integer
     */
    const RECORD_PRINT_STATUS_NO = 0;
    /**
     * 已打印
     * @var integer
     */
    const RECORD_PRINT_STATUS_YES = 1;
    /**
     * 打印状态 解释字段 print_status 含义
     * @var array
     */
    public static $_print_status = array(
        self::RECORD_PRINT_STATUS_NONE => '无需打印',
        self::RECORD_PRINT_STATUS_NO => '未打印',
    ...
    */
    ...
    public function search($page = 10, $area = false)
    {
        ...
        $this->timeSearch('t.exchange_time', $criteria, $this->exchange_time);
