...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'record_id',array('size'=>20,'maxlength'=>20)); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model,'express_status'); ?>
        <?php echo $form->dropDownList($model, 'status', array(''=>'--请选择--')+$model::$_express_status); ?>
    </div>
 
    <div class="row">
        <?php echo $form->label($model,'express_name'); ?>
        <?php echo $form->textField($model,'express_name',array('size'=>32,'maxlength'=>32)); ?>
    </div>
 
    <div class="row">
        <?php echo $form->label($model,'express_code'); ?>
        <?php echo $form->textField($model,'express_code',array('size'=>60,'maxlength'=>128)); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'express_time'); ?>
        <?php $model->timeSearchInput($model, 'express_time');?>
    </div>
