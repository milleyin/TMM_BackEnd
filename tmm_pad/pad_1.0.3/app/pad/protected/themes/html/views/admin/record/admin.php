...
// 删除页数
$params = $_GET;
$pageVar = CHtml::modelName($model) . '_page';
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'template' => 
    CHtml::link('下载Excel', $this->createUrl('record/download', $params))  . "{summary}\n{items}\n{pager}",
    'columns'=>array(
        array(
                'class'=>'DataColumn',
        ...
        array(
            ...
            'headerHtmlOptions'=>array('style'=>'text-align:center;width:65px;'),
            'htmlOptions'=>array('style'=>'text-align:center;', 'title'=>function ($row, $data) {
                    return $data->getAttributeLabel('print_status') . '：' . $data::$_print_status[$data->print_status];
                },
            ),
        ),
        array(
