<div class="content_box">
	...
	echo $this->breadcrumbs(array(
		'结伴游'=>array('/agent/agent_order/group'),
		'订单详情',
	));
	?>
	<div class="table_boxs">
		<table border="0" class="de">
			...
			<tr>
				<td>项目费用：</td><td>1000.00元</td>
			</tr>
			<tr>
				<td>保险费用：</td><td>200.00元</td>
			</tr>
			<tr>
				<td>总价：</td><td><?php echo CHtml::encode($model->order_price); ?>元</td>
			</tr>
			<tr>
				<td>我的收益：</td><td>100.00元</td>
			</tr>
			<tr>
				<td>订单状态：</td><td class="state_normal"><?php echo CHtml::encode(Order::$_pay_status[$model->order_status]); ?></td>
			</tr>
			<tr>
