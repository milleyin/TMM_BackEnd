...
");
?>
<h1>管理页 Store Contents</h1>
<div>
	</span>
		<?php echo CHtml::link('高级搜索','#',array('class'=>'search-button')); ?>	</span>
	 <span>
	 	<?php echo CHtml::link('创建StoreContent',array('create')); ?>	</span>
</div>
		...
		array(
			...
			'buttons'=>array(
					...
					'audit'=>array(
						...
						'url'=>'Yii::app()->createUrl("admin/tmm_storeContent/view",array("id"=>$data->id))',
 					    'options'=>array('style'=>'padding:0 8px 0 0;'),
					...
					'disable'=>array(
						...
						'url'=>'Yii::app()->createUrl("/admin/tmm_storeContent/disable",array("id"=>$data->id))',
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					...
					'start'=>array(
						...
						'url'=>'Yii::app()->createUrl("/admin/tmm_storeContent/start",array("id"=>$data->id))',
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
