...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'shops-grid',
	'dataProvider'=>$model->search_selected(),
	'enableHistory'=>true,
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
			'header'=>'操 作',
			'template'=>'{view}{update}{selected}{remove}{selected_tops}{selected_tops_no}{tags}{audit}{confirm}{pack}{delete}{disable}{start}{sale_yes}{sale_no}',
			'buttons'=>array(
					'view'=>array(
						'label'=>'查看',
