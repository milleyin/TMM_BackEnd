...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'bills-grid',
	'dataProvider'=>$model->search_cash($cash_id,$bills_count),
	'enableHistory'=>true,
...
//						'url'=>'Yii::app()->createUrl("/admin/tmm_bills/disable",array("id"=>$data->id))',
//						'click'=>$click,
//						'options'=>array('style'=>'padding:0 8px 0 0;'),
//					),
//					'start'=>array(
...
//						'url'=>'Yii::app()->createUrl("/admin/tmm_bills/start",array("id"=>$data->id))',
//						'click'=>$click,
//						'options'=>array('style'=>'padding:0 8px 0 0;'),
//					),
			),
