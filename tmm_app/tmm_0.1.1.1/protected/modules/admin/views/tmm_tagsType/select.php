...
$this->breadcrumbs=array(
	'树形管理页'=>array('tree'),
	'管理页'=>array('admin'),
	$select->name=>array('view','id'=>$select->id),
	'选择标签页'
);
...
");
?>
<h1>选择标签 <font color='#eb6100'><?php echo CHtml::encode($select->name); ?></font></h1>
<div>
<span>
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'tags-grid',
	'dataProvider'=>$model->select_tags($select->id),
	'enableHistory'=>true,
	...
	'columns'=>array(
		array(
				...
				'id'=>'tags',
				'value'=>'$data->id',
				'checked'=>'TagsSelect::checked($data->id,'.$select->id.')',
...
$url=Yii::app()->createUrl('/admin/tmm_tagsType/tags',array('id'=>$select->id));
