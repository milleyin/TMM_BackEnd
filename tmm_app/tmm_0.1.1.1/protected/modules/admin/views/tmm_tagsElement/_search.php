...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			<?php echo $form->label($model,'select_id'); ?>
			<?php echo $form->textField($model,'select_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'tags_id',array('size'=>11,'maxlength'=>11)); ?>
		</div>
