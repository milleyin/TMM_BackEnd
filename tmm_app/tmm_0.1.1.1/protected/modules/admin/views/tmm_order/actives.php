...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'order-grid',
	'dataProvider'=>$model->search_actives($order_actives_id),
	'enableHistory'=>true,
	...
	'columns'=>array(
		...
		array(
				...
				'name'=>'go_time',
				'value'=>'$data->Order_OrderActives->OrderActives_Actives->go_time==0?"--":Yii::app()->format->formatDateTime($data->Order_OrderActives->OrderActives_Actives->go_time)',
				//'type'=>'datetime',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:60px;'),
				'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		...
		array(
			...
			'buttons'=>array(
					'view'=>array(
						...
						'url'=>'Yii::app()->createUrl("/admin/tmm_order/actives_view",array("id"=>$data->id))',
					),
					'retinue'=>array(
						'label'=>'随行',
...
// 					'refund'=>array(
// 						'label'=>'申请退款',
// 						'visible'=>'$data->status==Order::status_yes && $data->order_status== Order::order_status_user_pay && OrderItems::Apply_actives($data->order_organizer_id) ',
// 						'click'=>$click,
