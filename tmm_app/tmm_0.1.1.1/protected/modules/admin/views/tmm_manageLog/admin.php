...
$('.search-form form').submit(function(){
	$('#manage-log-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
function(){ 
	...
	$.fn.yiiGridView.update('manage-log-grid',{  
	type:'POST',
...
function() {  
	...
	jQuery('#manage-log-grid').yiiGridView('update', {
		type: 'POST',
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'manage_id',
			'value'=>'$data::manage_type($data->manage_who, $data)',
		...
		array(
				...
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'$data->info'),
		),
		array(
				'class'=>'DataColumn',
				'evaluateHtmlOptions'=>true,
				...
				'htmlOptions'=>array('style'=>'text-align:center;','title'=>'$data->url'),
		),
		array(
				//'class'=>'DataColumn',
				//'evaluateHtmlOptions'=>true,
