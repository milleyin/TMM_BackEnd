...
if($model->audit_status==Cash::audit_status_submit) {
	?>
	<div class="row">
		<span class="buttons">
	<?php echo CHtml::ajaxButton('审核通过', array('/admin/tmm_refundLog/submits_pass', 'id' => $model->id),
		array(
			'cache' => true,
		...
		<span class="buttons">
	<?php echo CHtml::ajaxButton('审核不通过', array('/admin/tmm_refundLog/submits_nopass', 'id' => $model->id),
		array(
			'cache' => true,
			'success' => 'function(html){
					jQuery("#audit").html(html);
