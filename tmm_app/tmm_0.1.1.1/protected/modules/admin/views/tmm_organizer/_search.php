...
?>
		...
		<div class="row">
			<?php echo $form->label($model,'firm_phone'); ?>
	...
	<div class="row">
		...
		<div class="row">
			<?php echo $form->label($model,'law_name'); ?>
			<?php echo $form->textField($model,'law_name',array('size'=>10,'maxlength'=>10)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'law_identity'); ?>
			<?php echo $form->textField($model,'law_identity',array('size'=>18,'maxlength'=>18)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'law_phone'); ?>
		...
		<div class="row">
			<?php echo $form->label($model,'manage_email'); ?>
			<?php echo $form->textField($model,'manage_email',array('size'=>60,'maxlength'=>100)); ?>
		</div>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'manage_identity',array('size'=>18,'maxlength'=>18)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'identity_begin'); ?>
			<?php echo $form->textField($model,'identity_begin',array('size'=>60,'maxlength'=>100)); ?>
		</div>
		...
		<div class="row">
			...
			<?php echo $form->dropDownList($model,'bank_id',Bank::data_name()); ?>	
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="row">
			<?php echo $form->label($model,'is_push'); ?>
			<?php echo $form->dropDownList($model,'is_push',array(''=>'--请选择--')+$model::$_is_push); ?>
		</div>
		<div class="row">
