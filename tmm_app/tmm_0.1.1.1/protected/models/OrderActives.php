...
class OrderActives extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'actives_id' => '觅趣',
			'actives_type' => '觅趣分类',
			'user_order_count' => '下单总计',
			'user_pay_count' => '实际支付总计',
	...
	public function search($criteria='')
	{
		...
		if($criteria ===''){
			...
			$criteria->compare('OrderActives_User.phone',$this->organizer_id,true);
			$criteria->compare('Actives_Shops.name',$this->actives_id,true);
