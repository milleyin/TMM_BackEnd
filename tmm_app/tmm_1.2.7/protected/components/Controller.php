...
class Controller extends CController
{
	...
	public function  init()
	{
		...
		if(!is_dir(Yii::app()->basePath.'/runtime/error/operator'))
			mkdir(Yii::app()->basePath.'/runtime/error/operator', 0777, true);
		if(!is_dir(Yii::app()->basePath.'/runtime/error/api'))
			mkdir(Yii::app()->basePath.'/runtime/error/api', 0777, true);
		if(!is_dir(Yii::app()->basePath.'/runtime/error/store'))
			mkdir(Yii::app()->basePath.'/runtime/error/store', 0777, true);
		if(!is_dir(Yii::app()->basePath.'/runtime/error/admin'))
			mkdir(Yii::app()->basePath.'/runtime/error/admin', 0777, true);		
	...
	public function refreshToken()
	{
		if ($this->isRefreshToken)
			Yii::app()->request->unsetCsrfToken();
	}
