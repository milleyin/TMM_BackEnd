		...
		array(
			...
			'buttons'=>array(
					...
					'restore'=>array(
						...
						'url'=>'Yii::app()->createUrl("/admin/tmm_manageLog/restore",array("id"=>$data->id))',
						'click'=>$click,
						'options'=>array('style'=>'padding:0 8px 0 0;'),
					...
					'delete'=>array(
						'label'=>'彻底删除',
						'options'=>array('style'=>'padding:0 8px 0 0;'),
						'url'=>'Yii::app()->createUrl("/admin/tmm_manageLog/clear",array("id"=>$data->id))',
