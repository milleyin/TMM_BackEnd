						...
						<div class="box left">
							<div class="spot_content">
								<div class="row-fluid spot_name">
									...
									<?php //echo $form->textField($model->Actives_Shops,'name',array('class'=>'left_search','placeholder'=>'请输入点名称')); ?>
								...
								<div class="row-fluid spot_name">
									...
									<?php echo $form->dropDownList($model,'tour_type',array(Actives::tour_type_dot=>Actives::$_tour_type[Actives::tour_type_dot]),array('style'=>'min-width:150px;')); ?>
