...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'manage_id',array('size'=>20,'maxlength'=>20)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'use_count'); ?>
			<?php echo $form->textField($model,'use_count',array('size'=>11,'maxlength'=>11)); ?>
		</div>
		...
		<div class="row">
			...
			?>	
				...
				<div class="row">
			<?php echo $form->label($model,'use_address'); ?>
			<?php echo $form->textField($model,'use_address',array('size'=>60,'maxlength'=>128)); ?>
		</div>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'last_address',array('size'=>60,'maxlength'=>128)); ?>
		</div>
