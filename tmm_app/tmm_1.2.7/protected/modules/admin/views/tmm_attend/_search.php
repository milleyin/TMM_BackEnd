...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			<?php echo $form->label($model,'actives_id'); ?>
			<?php echo $form->textField($model,'actives_id',array('size'=>30,'maxlength'=>20)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'founder_id'); ?>
			<?php echo $form->textField($model,'founder_id',array('size'=>30,'maxlength'=>20)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'user_id'); ?>
			<?php echo $form->textField($model,'user_id',array('size'=>20,'maxlength'=>11)); ?>
		</div>
		...
		<div class="row">
			<?php echo $form->label($model,'is_people'); ?>
			<?php echo $form->dropDownList($model,'is_people',array(''=>'--请选择--')+$model::$_is_people); ?>		
		</div>
