...
$this->breadcrumbs=array(
	...
	$select->Dot_Shops->name=>array('view','id'=>$select->id),
	'选择标签页'
);
...
");
?>
<h1>选择标签 <font color='#eb6100'><?php echo CHtml::encode($select->Dot_Shops->name); ?></font></h1>
<div>
<span>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		array(
				...
				'name'=>'id',
				'id'=>'tags',
				'checked'=>'TagsElement::checked_element($data->id,'.$select->id.','.TagsElement::tags_shops_dot.')',
...
$url=Yii::app()->createUrl('/admin/tmm_dot/tags',array('id'=>$select->id));
