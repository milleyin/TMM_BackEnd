		...
		<div class="view">
			<div class="list_left">
				<div class="list_title">
					<span class="list_name">
						<?php 
							...
							echo CHtml::link($data->Pro_Items->name, array('/admin/tmm_'.$data->Pro_ItemsClassliy->admin.'/view', 'id'=>$data->Pro_Items->id));
				...
				<div class="list_store">
					...
					<span title="运营商账号">
						<?php echo CHtml::encode($data->Pro_Items->Items_agent->phone); ?>
					</span>
					<label class="label_title">
						供应商:
					</label>
