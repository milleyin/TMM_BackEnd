...
$this->breadcrumbs=array(
	'商品管理页'=>array('admin'),
	'商品（' . $model->getAttributeLabel('selected_tops') . '）管理页',
);
	...
	'columns'=>array(
		...
		array(
				'filter'=>$this->widget('zii.widgets.jui.CJuiDatePicker',array(
						...
						'htmlOptions'=>array(
								'id' =>'selected_tops_time_date',
						),
				),true),
				'name'=>'selected_tops_time',
				'type'=>'datetime',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:80px;'),
				'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		...
		array(
			'class'=>'CButtonColumn',
			'header'=>'操 作',
			'template'=>'{view}{update}{selected}{selected_tops}{selected_tops_no}{delete}{disable}{start}',
			'buttons'=>array(
					'view'=>array(
						'label'=>'查看',
