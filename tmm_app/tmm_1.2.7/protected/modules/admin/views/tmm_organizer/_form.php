...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php 
		if($this->file_exists_uploads($model->bl_img)){
	...
	<?php 
		if($this->file_exists_uploads($model->identity_begin)){
	...
	<?php 
		if($this->file_exists_uploads($model->identity_after)){
	...
	<?php 
		if($this->file_exists_uploads($model->identity_hand)){
	...
	<?php 
		if($this->file_exists_uploads($model->identity_job)){
