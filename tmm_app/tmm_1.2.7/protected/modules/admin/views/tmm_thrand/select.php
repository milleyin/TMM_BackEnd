...
$this->breadcrumbs=array(
	...
	$select->Thrand_Shops->name=>array('view','id'=>$select->id),
	'选择标签页'
);
...
");
?>
<h1>选择标签 <font color='#eb6100'><?php echo CHtml::encode($select->Thrand_Shops->name); ?></font></h1>
<div>
<span>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		//		'value'=>'$data->id',
				'id'=>'tags',
				'checked'=>'TagsElement::checked_element($data->id,'.$select->id.','.TagsElement::tags_shops_thrand.')',
...
$url=Yii::app()->createUrl('/admin/tmm_thrand/Tags',array('id'=>$select->id));
