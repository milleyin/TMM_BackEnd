 ...
 *
 */
class StoreMainController extends AppController
{
	/**
	 ...
	 * @param $id
	 */
	public static function verify_store_login()
	{
		$model_store = StoreUser::model()->find(' status=1 AND p_id=0 AND  id='.Yii::app()->store->id);
		if(!$model_store)
