...
class CategoryModel extends RelationModel{
	...
	protected $_link = array(
		'CategoryCover' => array(
			...
			'class_name'     => 'Picture',
			'mapping_fields' => 'path as icon_path',
			'foreign_key'    => 'icon',
			'as_fields'      => 'icon_path',
		),
		'CategoryDetailCover' => array(
			// 分类列表图
			'mapping_type'   => self::BELONGS_TO,
			'class_name'     => 'Picture',
			'mapping_fields' => 'path as detail_icon_path',
			'foreign_key'    => 'detail_icon',
			'as_fields'      => 'detail_icon_path',
		),
		'CategoryArticle' => array(
			// 统计分类下的文章数
			'mapping_type'   => self::HAS_MANY,
			'class_name'     => 'Document',
			'mapping_fields' => 'count(`id`) as articleCount',
