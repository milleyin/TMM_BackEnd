...
$('.search-form form').submit(function(){
	$('#deposit-log-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
				...
				//'filter'=>,
				'name'=>'admin_id',
				'value'=>'$data->DepositLog_Admin->username."[".$data->DepositLog_Admin->name."]"',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		array(
				//'class'=>'DataColumn',
				//'evaluateHtmlOptions'=>true,
				'filter'=>$model::$_deposit_who,
				'name'=>'deposit_who',
				'value'=>'$data::$_deposit_who[$data->deposit_who]',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		array(
			...
			//'filter'=>,
			'name'=>'deposit_id',
			'value'=>'$data::deposit_type($data->deposit_who, $data)',
			'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
			'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		array(
			//'class'=>'DataColumn',
			//'evaluateHtmlOptions'=>true,
			'filter'=>$model::$_deposit_status,
			'name'=>'deposit_status',
			'value'=>'$data::$_deposit_status[$data->deposit_status]',
			'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
			'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		array(
