<?php
/* @var $this Tmm_orderOrganizerController */
/* @var $model OrderOrganizer */
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'shops_list_info',array('size'=>60,'maxlength'=>128)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'shops_page_info'); ?>
			<?php echo $form->textField($model,'shops_page_info',array('size'=>60,'maxlength'=>128)); ?>
		</div>

	<div class="row">
			<?php echo $form->label($model,'shops_pub_time'); ?>
			<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array(
						'language'=>Yii::app()->language,
						'model'=>$model,
						'attribute'=>'shops_pub_time',
						'value'=>date('Y-m-d'),
						'options'=>array(
								'maxDate'=>'new date()',
								'dateFormat'=>'yy-mm-dd',
			...
			<div class="row">
			<?php echo $form->label($model,'shops_up_time'); ?>
			<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array(
						'language'=>Yii::app()->language,
						'model'=>$model,
						'attribute'=>'shops_up_time',
						'value'=>date('Y-m-d'),
						'options'=>array(
								'maxDate'=>'new date()',
								'dateFormat'=>'yy-mm-dd',
			...
			<div class="row">
			<?php echo $form->label($model,'shops_add_time'); ?>
			<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array(
						'language'=>Yii::app()->language,
						'model'=>$model,
						'attribute'=>'shops_add_time',
						'value'=>date('Y-m-d'),
						'options'=>array(
								'maxDate'=>'new date()',
								'dateFormat'=>'yy-mm-dd',
		...
		<div class="row">
			<?php echo $form->label($model,'group_remark'); ?>
			<?php echo $form->textArea($model,'group_remark',array('rows'=>6, 'cols'=>50)); ?>
		</div>

	<div class="row">
			<?php echo $form->label($model,'group_start_time'); ?>
			<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array(
						'language'=>Yii::app()->language,
						'model'=>$model,
						'attribute'=>'group_start_time',
						'value'=>date('Y-m-d'),
						'options'=>array(
								'maxDate'=>'new date()',
								'dateFormat'=>'yy-mm-dd',
			...
			<div class="row">
			<?php echo $form->label($model,'group_end_time'); ?>
			<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array(
						'language'=>Yii::app()->language,
						'model'=>$model,
						'attribute'=>'group_end_time',
						'value'=>date('Y-m-d'),
						'options'=>array(
								'maxDate'=>'new date()',
								'dateFormat'=>'yy-mm-dd',
			...
			<div class="row">
			<?php echo $form->label($model,'group_group_time'); ?>
			<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array(
						'language'=>Yii::app()->language,
						'model'=>$model,
						'attribute'=>'group_group_time',
						'value'=>date('Y-m-d'),
						'options'=>array(
								'maxDate'=>'new date()',
								'dateFormat'=>'yy-mm-dd',
	   ...
	   <div class="row">
			<?php echo $form->label($model,'group_group'); ?>
			<?php echo $form->dropDownList($model,'group_group',array(''=>'--请选择--')+$model::$_group_group);?>
		</div>
