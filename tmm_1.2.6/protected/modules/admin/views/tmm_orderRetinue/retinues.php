...
$('.search-form form').submit(function(){
	$('#order-retinue-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
function(){ 
	...
	$.fn.yiiGridView.update('order-retinue-grid',{  
	type:'POST',
...
function() {  
	...
	jQuery('#order-retinue-grid').yiiGridView('update', {
		type: 'POST',
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'order-retinue-grid',
	'dataProvider'=>$model->search_order($order_id),
	'enableHistory'=>true,
	...
	'columns'=>array(
		...
		array(
				'filter'=>CHtml::activeDropDownList($model, 'retinue_gender',array(''=>'')+OrderRetinue::$_retinue_gender, array('id'=>false)),
				'name'=>'retinue_gender',
				'value'=>'$data::$_retinue_gender[$data->retinue_gender]',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		array(
		...
		array(
				'filter'=>CHtml::activeDropDownList($model, 'insure_gender',array(''=>'')+OrderRetinue::$_insure_gender, array('id'=>false)),
				'name'=>'insure_gender',
				'value'=>'$data::$_insure_gender[$data->insure_gender]',
				'headerHtmlOptions'=>array('style'=>'text-align:center;width:50px;'),
				'htmlOptions'=>array('style'=>'text-align:center;'),
		),
		array(
		...
		array(
				'filter'=>CHtml::activeDropDownList($model, 'is_main',array(''=>'')+OrderRetinue::$_is_main, array('id'=>false)),
				'name'=>'is_main',
		...
		array(
				'filter'=>CHtml::activeDropDownList($model, 'status',array(''=>'')+OrderRetinue::$_status, array('id'=>false)),
				'name'=>'status',
