...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'admin',array('size'=>45,'maxlength'=>45)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'main'); ?>
			<?php echo $form->textField($model,'main',array('size'=>45,'maxlength'=>45)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'append'); ?>
			<?php echo $form->textField($model,'append',array('size'=>45,'maxlength'=>45)); ?>
		</div>

		<div class="row">
			<?php echo $form->label($model,'nexus'); ?>
			<?php echo $form->textField($model,'nexus',array('size'=>45,'maxlength'=>45)); ?>
		</div>
		<div class="row">
			<?php echo $form->label($model,'is_agent'); ?>
			<?php echo $form->dropDownList($model,'is_agent',array(''=>'--请选择--')+$model::$_is_agent); ?>
		</div>
	<div class="row">
