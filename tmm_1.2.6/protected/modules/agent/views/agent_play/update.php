<div class="content_box page_project_redact page_project_redact_again" id="page_project_create">
    ...
    <!--.title-->
    <?php
    if($model->Play_Items->audit==Items::audit_nopass){
        ?>
        <div class="box check_failed">
            <div><span>审核不通过原因</span></div>
            <div><span><?php echo AuditLog::get_audit_log(AuditLog::items_play,$model->id,AuditLog::nopass)->info;?></span></div>
        </div>
        <?php
    }
    ?>
    ...
    <div class="content">
        <div class="content_two">
            <?php
            if(isset($model->Play_ItemsImg[0]))
                $Play_ItemsImg=$model->Play_ItemsImg[0];
            else
                $Play_ItemsImg=new ItemsImg;
            ?>
            <?php
            ...
            <div class="row-fluid">
                ...
                <div class="col_proname">
                    <?php echo $form->textField($model->Play_Items,'name',array('maxlength'=>100,'class'=>'p_name')); ?>
            ...
            <div class="row-fluid address_group">
                ...
                <div class="col-province">
                    <?php echo $form->dropDownList($model->Play_Items,'area_id_p',Area::data_array_id(0,array(''=>'省')),array(
                        'class'=>'province',
                        'ajax'=>array(
                            'type'=>'POST',
                ...
                <div class="col-city">
                    <?php
                    echo $form->dropDownList($model->Play_Items,'area_id_m',Area::data_array_id($model->Play_Items->area_id_p,array(''=>'市')),array(
                        'class'=>'city',
                        'ajax'=>array(
                            'type'=>'POST',
                            'url'=>Yii::app()->createUrl('/agent/agent_home/area'),
                ...
                <div class="col-area">
                    <?php echo $form->dropDownList($model->Play_Items,'area_id_c',Area::data_array_id($model->Play_Items->area_id_m,array(''=>'区/县')),array(
                        'class'=>'area',
                    )); ?>
                    <?php echo $form->error($model->Play_Items,'area_id_c'); ?>
                </div>
                <div class="col-address">
                    <?php echo $form->textField($model->Play_Items,'address',array('maxlength'=>40,'class'=>'address')); ?>
            ...
            <div class="row-fluid address_uploading_group">
                ...
                <div class="file_normal">
                    <?php echo $form->fileField($model->Play_Items,'map',array('class'=>'uploading')); ?>
                    <?php echo $form->error($model->Play_Items,'map'); ?>
                </div>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="row-fluid col_name">
                                        <?php echo $form->textField($Play_Fare,"[$key]name",array('placeholder'=>'商品名称','class'=>'table_box one')); ?>
                                        <?php echo $form->error($Play_Fare,"[$key]name"); ?>
                                    </div>
                                </td>
                                <td>
                                    <div class="row-fluid col_type">
                                        <?php echo $form->textField($Play_Fare,"[$key]info",array('placeholder'=>'类型','class'=>'table_box two')); ?>
                                        <?php echo $form->error($Play_Fare,"[$key]info"); ?>
                                    </div>
                                </td>
                                <td>
                                    <div class="row-fluid col_price">
                                        <?php echo $form->textField($Play_Fare,"[$key]price",array('placeholder'=>'价格','class'=>'table_box last')); ?>
										<button class="<?php echo $key>0?'cut_sub':'add_and_sub';?>" >
                                            <?php echo $key>0?'-':'+';?>
                                        </button>
                                        <?php echo $form->error($Play_Fare,"[$key]price"); ?>
                                    </div>
                                </td>
                            </tr>
                        <?php  } ?>
            ...
            <div class="row-fluid general_group">
                ...
                <div class="general_uploading">
                    <div class="general_btn">
                        <div>
                            <?php echo $form->fileField($Play_ItemsImg,'tmp',array('class'=>'btn')); ?>
            ...
            <div class="row-fluid intro_group">
                ...
                <div class="rich_text_editor">
                    ...
                    $this->renderPartial('/_common/_html',array(
                        ...
                        'height'=>'220px',
                        'model'=>$model->Play_Items,
                        'filespath'=>Yii::app ()->basePath .'/..'.Yii::app()->params['uploads_items_editor_play'],
                        'filesurl'=>Yii::app ()->baseUrl . Yii::app()->params['uploads_items_editor_play'],
                        'attribute'=>'content',
                    ));
                    ?>
                </div>
            ...
            <div class="row-fluid">
                ...
                <div class="contact_group">
                    <div class="row-fluid phone_icon">
                        <?php echo $form->textField($model->Play_Items,'phone',array('maxlength'=>20)); ?>
                        <?php echo $form->error($model->Play_Items,'phone'); ?>
                    </div>
                    <div class="weixin_icon">
                        <?php echo $form->textField($model->Play_Items,'weixin',array('maxlength'=>20)); ?>
...
<script type="text/javascript">
	...
	$nunber=Yii::app()->params['items_image_number']-count($model->Play_ItemsImg);
    ...
    jQuery(function($){
        $("#<?php echo CHtml::activeId($Play_ItemsImg, 'tmp') ?>").uploadify({
            ...
            'uploader': '<?php echo Yii::app()->createUrl('/agent/agent_play/uploads')?>&<?php echo $csrf; ?>',
            'auto': true,
            'multi': true,
        ...
        function delete_file() {
            jQuery(".uploadify-queue-item a").on('click', function () {
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: '<?php echo Yii::app()->createUrl('/agent/agent_play/uploads')?>&<?php echo $csrf; ?>',
        ...
        function update_number(limit_number){
            $("#<?php echo CHtml::activeId($Play_ItemsImg, 'tmp');?>").uploadify('settings','uploadLimit',limit_number);
        }
        function old_uploadify(){
            setTimeout(function(){
                jQuery("#old_uploadify").val(jQuery("#<?php echo CHtml::activeId($Play_ItemsImg, 'tmp');?>-queue").html());
            }, 2000);
        }
