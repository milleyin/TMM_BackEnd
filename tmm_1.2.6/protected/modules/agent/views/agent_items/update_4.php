<div class="content_box page_project_redact" id="page_project_create">
<?php
	...
	<div class="content">
		<div class="content_five">
				...
				<div class="box box_one">
					...
					<div class="right">
						<div class="business_name">
							...
							<span class="small">
								审核进度请致电：<?php echo Yii::app()->params['tmm_400']?>咨询
							</span>
						</div>
					</div>
					<!-- .right -->
			...
			<div class="row-fluid enter check">
			     <?php echo CHtml::link('<span>返回项目</span>',array('/agent/agent_items/admin'));?>
			</div>
		</div>
		<!-- .content_five -->
	</div>
